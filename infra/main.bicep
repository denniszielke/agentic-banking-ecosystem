...
param aiFoundryProjectName string = 'ai-banking-${environmentName}'

@description('Name of the financial products vector index')
param financialProductsIndexName string = 'financial-products'

@description('Name of the compliance rules vector index')
param complianceRulesIndexName string = 'compliance-rules'
...
output AZURE_SEARCH_FINANCIAL_PRODUCTS_INDEX_NAME string = financialProductsIndexName
output AZURE_SEARCH_COMPLIANCE_RULES_INDEX_NAME string = complianceRulesIndexName
